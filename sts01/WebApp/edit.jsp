		...
		<div class="row content">
			...
			<form action="update.do" class="form-horizontal" method="post">
				<div class="form-group">
					...
					<div class="col-sm-10"><input type="text" value="${bean.sabun }" readonly="readonly" class="sabun"  name="sabun" placeholder="사번입력"/></div>
				</div>
				<div class="form-group">
					<label for="name" class="col-sm-2 control-label">이름</label>
					<div class="col-sm-10"><input type="text"  value="${bean.name }"  class="name"  name="name" placeholder="이름입력"/></div>
				</div>
				<div class="form-group">
					<label for="nalja" class="col-sm-2 control-label">날짜</label>
					<div class="col-sm-10"><input type="Date"  value="${bean.nalja }"  class="nalja"  name="nalja" placeholder="날짜입력"/></div>
				</div>
				<div class="form-group">
					<label for="pay" class="col-sm-2 control-label">금액</label>
					<div class="col-sm-10"><input type="text"  value="${bean.pay }"  class="pay"  name="pay" placeholder="금액입력"/></div>
				</div>
				<button>입력</button>
			</form>
